      ...
      <main className="min-h-screen w-full bg-black text-white relative">
        <section className="h-screen flex items-center justify-center relative overflow-hidden snap-start">
          ...
          <div className="max-w-6xl mx-auto text-center relative z-10 px-4">
            <div className="relative flex flex-col items-center">
              <img
                src={AVATAR}
                alt="Rusty AI"
                className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover mb-8 rust-avatar-glow border-2 border-red-600/50"
              />
          ...
          <button
            ...
            className="absolute bottom-10 left-1/2 transform -translate-x-1/2 z-10 flex flex-col items-center gap-2 group"
          >
            <span className="text-sm text-gray-400 group-hover:text-red-400 transition-colors">
              Пролистни вниз и задай вопрос
            </span>
            <span className="animate-bounce bg-red-600/20 group-hover:bg-red-600/30 border border-red-600/40 transition-all duration-300 rounded-lg p-2">
              <svg
        ...
        <section className="min-h-screen py-16 px-4 md:px-6 snap-start bg-black flex flex-col justify-center relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto w-full relative z-10">
            <div className="mb-8 text-center">
              ...
              <div className="mt-2 w-20 h-px mx-auto bg-gradient-to-r from-transparent via-red-600 to-transparent" />
            </div>
            <RustyChat />
          </div>
        </section>
